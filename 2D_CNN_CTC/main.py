...
characters = ["cel", "cla", "flu", "gac", "gel", "org", "pla", "sax", "tru", "vio", "voi"]
...
for label in characters:
  ...
  for file in wav_files:
    ...
    if rand < 80:
      training_set[0].append(file)
      training_set[1].append(label)
    else:
      validation_set[0].append(file)
      validation_set[1].append(label)
...
#     file = tf.io.read_file(training_set[0][0])
